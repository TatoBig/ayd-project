...
class Button:
    ...
    def prepare_text(self):
        ...
        self.text_image = self.font.render("Inicio", True, self.text_color, self.button_color)
        self.text_image_rectangle = self.text_image.get_rect()
        self.text_image_rectangle.center = self.button_rectangle_start.center
        self.text_image_two = self.font.render("Creditos", True, self.text_color, self.button_color)
        ...
        self.text_image_three = self.font.render("Salir", True, self.text_color, self.button_color)
        ...
        self.text_tittle = self.font_tittle.render("Analisis y diseño", True, self.text_color, self.button_color)
